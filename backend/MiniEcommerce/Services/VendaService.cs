    ...
    public class VendaService : IVendaService
    {
        ...
        public Venda Create(CreateVendaDto dto)
        {
            ...
            foreach (var item in dto.Itens)
            {
                ...
                if (produto == null)
                    throw new Exception($"Produto com ID {item.ProdutoId} n�o encontrado");

                // Confere estoque dispon�vel.
                if (produto.Estoque < item.Quantidade)
                    throw new Exception($"Estoque insuficiente para {produto.Nome}. Dispon�vel: {produto.Estoque}");
            ...
            // Se tudo ok, grava a venda e atualiza o estoque dentro de uma transa��o.
